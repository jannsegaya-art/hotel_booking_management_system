...
<head>
    ...
    <title>@yield('title','Staff') — Grand Royal Hotel</title>
...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="pb-4">
        ...
        <a href="{{ route('staff.bookings.index') }}" class="sidebar-link {{ request()->routeIs('staff.bookings.index') ? 'active' : '' }}">
            <i class="bi bi-calendar-check"></i> My Bookings
        </a>
        <a href="{{ route('staff.bookings.all') }}" class="sidebar-link {{ request()->routeIs('staff.bookings.all') ? 'active' : '' }}">
...
<div class="topbar">
    <div class="d-flex align-items-center gap-3">
        ...
        <span class="fw-semibold d-none d-md-block" style="color:var(--primary);">Staff Panel</span>
    </div>
    <div class="d-flex align-items-center gap-2">
        <img src="{{ auth()->user()->profile_photo_url }}"
             class="rounded-circle shadow-sm"
             style="width:36px; height:36px; object-fit:cover; border:2px solid var(--secondary);"
             alt="Avatar"
        ...
        <div class="d-none d-md-block lh-1">
            ...
            <div style="font-size:.7rem;color:var(--secondary);">Staff</div>
        </div>
    </div>
</div>
